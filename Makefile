...
OBJS = build/boot.o build/isr.o build/kernel.o build/idt.o build/pic.o build/pit.o build/keyboard.o
...
build/kernel.o: kernel/kernel.c kernel/terminal.h kernel/idt.h kernel/pic.h kernel/pit.h kernel/keyboard.h | build-dir
	$(CC) -c kernel/kernel.c -o build/kernel.o $(CFLAGS)

build/idt.o: kernel/idt.c kernel/idt.h kernel/terminal.h kernel/pic.h | build-dir
...
build/keyboard.o: kernel/keyboard.c kernel/keyboard.h kernel/idt.h kernel/io.h kernel/terminal.h | build-dir
